...
var debug = require('debug')('AliOssService')
...
AliOssService.prototype.upload = function (req, res, options, cb) {
    ...
    busboy.on('file', function (fieldname, file, filename, encoding, mimetype) {
        ...
        var ts = moment().format('YYYY_MM_DD_HH_mm_ss_SSSS')+"_"+Math.round(Math.random()*100000);
        var ossfilename = ts+"_"+key;
